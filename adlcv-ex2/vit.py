...
class Attention(nn.Module):
    ...
    def forward(self, x):
        ...
        return self.o_projection(out), self.attention
...
class ViT(nn.Module):
    def __init__(self, image_size, channels, patch_size, embed_dim, num_heads, num_layers,
        ...
        self.to_patch_embedding = nn.Sequential(
            Rearrange('b c (nph ph) (npw pw) -> b (nph npw) (c ph pw)', ph=patch_h, pw=patch_w),
    ...
    def forward(self, img):
        ...
        return self.classifier(x), attentions